        ...
        <div class="space-y-6">
          <div class=" bg-white  dark:border-gray-700 dark:bg-gray-800 space-y-6">
            ...
            <div class=" md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
              <a href="#" class="">
                <img class="h-40 w-40 dark:hidden" src="https://static.nike.com/a/images/c_limit,w_592,f_auto/t_product_v1/u_126ab356-44d8-4a06-89b4-fcdcc8df0245,c_scale,fl_relative,w_1.0,h_1.0,fl_layer_apply/2bdbbe3a-d2b1-4b78-882a-64f43ee0bf7a/WMNS+AIR+JORDAN+1+LOW+SE.png" alt="imac image" />
              ...
              <div class="flex items-center justify-between md:order-3 md:justify-end">
                ...
                <div class="text-end">
                  <p class="text-base font-bold text-gray-900 dark:text-white">Rp. 1.850.000</p>
                </div>
              </div>

              <div class="w-full min-w-0 flex-1">
                <a href="#" class="text-base font-medium text-gray-900 hover:underline dark:text-white">Air Jordan 1 Low</a>
