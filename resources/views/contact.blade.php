...
<div class="max-w-screen-lg mx-auto p-12">
    <div class="grid grid-cols-1 md:grid-cols-12 border rounded-lg">
        <div class="bg-gray-900 md:col-span-4 p-10 text-white rounded-lg">
            ...
            <div class="flex items-center mt-5">
                ...
                <span class="text-sm">Jl. Pegangsaan Timur No.56 Jakarta Timur, Jawa Barat</span>
            </div>
            <div class="flex items-center mt-5">
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z">
                ...
                <span class="text-sm">+62 857 8679 5542</span>
            </div>
            <div class="flex items-center mt-5">
                <svg class="h-6 mr-2 text-indigo-600" fill="currentColor" version="1.1" id="Capa_1"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
