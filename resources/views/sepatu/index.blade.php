...
<div class="flex justify-center w-screen h-screen bg-white pt-8">
  <!-- Left Section -->
  ...
  <div class="flex justify-between items-center mb-4">
        ...
        <h1 class="text-3xl font-semibold italic">{{ $sepatu->nama }}</h1>
        <p class="text-gray-600 mb-1">Colour Shown: {{ $sepatu->deskripsi }}</p>
        <div class="flex items-center mb-4">
            <span class="text-grey-500 text-xl font-semibold">Rp. {{ number_format($sepatu->harga) }}</span>
        </div>
        @endforeach
        ...
        @csrf
        <button type="submit" class="btn btn-primary bg-black text-white py-3 px-6 w-full flex items-center justify-between">Tambah ke Keranjang</button>
        </form>
